# ESP32-WiFi-Sensing-2: Contactless Respiration Rate Detection
...
![Data Overview](./asset/physionet_data_overview.png)
*Hình 3: Phân phối BPM và đặc trưng sóng nhịp thở từ bộ dữ liệu tham chiếu.*
